...
<head>
    ...
    <title>CASA and Grade School Montessori</title>
        ...
        <div class="dept-hero">
            <div class="dept-hero-inner">
                <nav class="dept-breadcrumb" aria-label="breadcrumb">
                    ...
                    <i class="bi bi-chevron-right"></i>
                    <span class="dept-current">CASA and Grade School Montessori</span>
                </nav>
                <h1>CASA and Grade School Montessori</h1>
        ...
        <div class="dept-about-inner skeleton-group">
            ...
            <div class="dept-logo-wrap">
                ...
                <div class="skeleton-wrap" style="display:inline-block;">
                    <img src="/assets/images/logos/casa-monte-logo.svg" alt="CASA and Grade School Montessori logo" class="dept-logo">
                </div>
            ...
            <div class="dept-about-content">
                ...
                <div class="skeleton-real-content">
                    ...
                    <h2>About the CASA and Grade School Montessori</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis ab ipsam minus, exercitationem commodi accusantium totam quidem! Eos praesentium iste minus fuga aliquid repellat sint velit magni ea, harum neque.</p>
                </div>
            </div>
    ...
    <section class="dept-principal">
        <div class="dept-principal-inner">
            ...
            <div class="dept-principal-intro">
                ...
                <p>Meet the visionary leader guiding the CASA and Grade School Montessori in advancing academic excellence, innovation, and service.</p>
            </div>
                ...
                <div class="dept-principal-photo-wrap">
                    ...
                    <div class="dept-principal-photo">
                        <div class="skeleton-wrap">
                            <img src="/assets/images/hic-nulud.png" alt="Principal Photo" class="dept-principal-img">
                        </div>
                        ...
                        <div class="dept-principal-badge">
                            <span class="dept-principal-badge-title">OIC</span>
                            <span class="dept-principal-badge-sub">CASA and Grade School Montessori</span>
                        </div>
                    </div>
                        ...
                        <div class="dept-principal-contacts-grid">
                            <div class="dept-principal-contact">
                                ...
                                <div>
                                    ...
                                    <span class="dept-contact-value">(045) 900-4473 Loc. 121</span>
                                </div>
                            </div>
                            ...
                            <div class="dept-principal-contact">
                                ...
                                <div>
                                    <span class="dept-contact-label">Montessori Office</span>
                                    <span class="dept-contact-value">Banzali Hall, Floor 2, Room 200</span>
                                </div>
                            </div>

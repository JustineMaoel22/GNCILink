            ...
            <div class="dept-programs-grid">
                ...
                <div class="dept-program-card">
                    <div class="dept-program-img">
                        <img src="/assets/images/programs/bscoe.jpg" alt="Bachelor of Science in Civil Engineering">
                    </div>
                    <div class="dept-program-body">
                        <h3>Bachelor of Science in Civil Engineering</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="/pages/academics/programs/civil-engr.php" class="dept-program-link">

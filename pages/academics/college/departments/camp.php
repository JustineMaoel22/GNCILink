...
<head>
    ...
    <title>College of Medical Allied Programs</title>
        ...
        <div class="dept-hero">
            <div class="dept-hero-inner">
                <nav class="dept-breadcrumb" aria-label="breadcrumb">
                    ...
                    <i class="bi bi-chevron-right"></i>
                    <span class="dept-current">College of Medical Technology and Pharmacy</span>
                </nav>
                <h1>College of Medical Technology and Pharmacy</h1>
        ...
        <div class="dept-about-inner skeleton-group">
            ...
            <div class="dept-logo-wrap">
                ...
                <div class="skeleton-wrap">
                    <img src="/assets/images/logos/camp-logo.svg" alt="College of Medical Allied Programs seal" class="dept-logo">
                </div>
            ...
            <div class="dept-about-content">
                ...
                <div class="skeleton-real-content">
                    ...
                    <h2>About the College of Medical Technology and Pharmacy</h2>
                    <p>The College of Medical Technology and Pharmacy supports students through academic advising, internship coordination, hospital affiliations, licensure preparation, certifications, and consistent advocacy while ensuring compliance with CHED and PRC requirements.</p>
                </div>
            </div>
            ...
            <div class="dept-programs-grid">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/medtech-pic.png" alt="Bachelor of Science in Medical Laboratory Science">
                    </div>
                    <div class="dept-program-body">
                        ...
                        <div class="skeleton-real-content">
                            <h3>Bachelor of Science in Medical Laboratory Science</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/college/programs/medtech.php" class="dept-program-link">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/pharmacy-hero-placeholder.png" alt="Bachelor of Science in Pharmacy"> 
                    </div>
                    <div class="dept-program-body">
                        <div class="skeleton-text-lines">
                            <span class="skeleton-line skeleton-line--title skeleton-line--80"></span>
                        ...
                        <div class="skeleton-real-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/college/programs/pharmacy.php" class="dept-program-link">
                                VIEW DETAILS <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
    ...
    <section class="dept-dean">
        <div class="dept-dean-inner">
            ...
            <div class="dept-dean-intro">
                ...
                <p>Meet the visionary leader guiding the College of Medical Technology and Pharmacy in advancing academic excellence, innovation, and service.</p>
            </div>
            ...
            <div class="dept-dean-grid skeleton-group">
                ...
                <div class="dept-dean-photo-wrap">
                    ...
                    <div class="dept-dean-photo">
                        <div class="skeleton-wrap">
                            <img src="/assets/images/sir-capati.png" alt="Juan Paolo S. Capati, Dean of the College of Medical Technology and Pharmacy">
                        </div>
                        ...
                        <div class="dept-dean-badge">
                            ...
                            <span class="dept-dean-badge-sub">College of Medical Technology and Pharmacy</span>
                        </div>
                    </div>
                ...
                <div class="dept-dean-content">
                    ...
                    <div class="skeleton-real-content">
                        ...
                        <h3>Juan Paolo S. Capati, RMT, RPh</h3>
                        ...
                        <div class="dept-dean-contacts-grid">
                            <div class="dept-dean-contact">
                                ...
                                <div>
                                    ...
                                    <span class="dept-contact-value">(045) 900-4473 Loc. 137</span>
                                </div>
                            </div>
                            ...
                            <div class="dept-dean-contact">
                                ...
                                <div>
                                    <span class="dept-contact-label">CAMP Office</span>
                                    <span class="dept-contact-value">Limlingan Hall, Floor 2, Room 206</span>
                                </div>
                            </div>

        ...
        <div class="dept-hero">
            <div class="dept-hero-inner">
                <nav class="dept-breadcrumb" aria-label="breadcrumb">
                    ...
                    <i class="bi bi-chevron-right"></i>
                    <span class="dept-current">College of Nursing</span>
                </nav>
        ...
        <div class="dept-about-inner skeleton-group">
            ...
            <div class="dept-logo-wrap">
                ...
                <div class="skeleton-wrap" style="display:inline-block;">
                    <img src="/assets/images/logos/con-logo.svg" alt="College of Nursing seal" class="dept-logo">
                </div>
            ...
            <div class="dept-about-content">
                ...
                <div class="skeleton-real-content">
                    ...
                    <h2>About the College of Nursing</h2>
                    <p>The College of Nursing provides education for aspiring registered nurses through lectures and related learning experiences in hospitals and community students.</p>
                </div>
            </div>
            ...
            <div class="dept-programs-grid">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/nursing-pic.png" alt="Bachelor of Science in Nursing">
                    </div>
                    <div class="dept-program-body">
                        ...
                        <div class="skeleton-real-content">
                            ...
                            <a href="/pages/academics/college/programs/nursing.php" class="dept-program-link">
    ...
    <section class="dept-dean">
        <div class="dept-dean-inner">
            ...
            <div class="dept-dean-intro">
                ...
                <p>Meet the visionary leader guiding the College of Nursing in advancing academic excellence, innovation, and service.</p>
            </div>
            ...
            <div class="dept-dean-grid skeleton-group">
                ...
                <div class="dept-dean-photo-wrap">
                    ...
                    <div class="dept-dean-photo">
                        <div class="skeleton-wrap">
                            <img src="/assets/images/maam-bernardo.png" alt="Wilhelmina G. Bernardo, Dean of the College of Nursing">
                        </div>
                        ...
                        <div class="dept-dean-badge">
                            ...
                            <span class="dept-dean-badge-sub">College of Nursing</span>
                        </div>
                    </div>
                ...
                <div class="dept-dean-content">
                    ...
                    <div class="skeleton-real-content">
                        ...
                        <h3>Wilhelmina G. Bernardo, MAN, RN, RM</h3>
                        ...
                        <div class="dept-dean-contacts-grid">
                            ...
                            <div class="dept-dean-contact">
                                ...
                                <div>
                                    <span class="dept-contact-label">Nursing Office</span>
                                    <span class="dept-contact-value">Limlingan Hall, Floor 2, Room 208</span>
                                </div>
                            </div>

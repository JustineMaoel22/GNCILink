            ...
            <div class="dept-programs-grid">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/test-image.png" alt="Bachelor of Science in Accounting Information System">
                    </div>
                    <div class="dept-program-body">
                        ...
                        <div class="skeleton-real-content">
                            ...
                            <a href="/pages/academics/college/programs/acc-info-sys.php" class="dept-program-link">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/test-image.png" alt="Bachelor of Science in Accountancy">
                    </div>
                    <div class="dept-program-body">
                        <div class="skeleton-text-lines">
                            <span class="skeleton-line skeleton-line--title skeleton-line--80"></span>
                        ...
                        <div class="skeleton-real-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/college/programs/accountancy.php" class="dept-program-link">
                                VIEW DETAILS <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="dept-dean-contacts-grid">
                            <div class="dept-dean-contact">
                                ...
                                <div>
                                    ...
                                    <span class="dept-contact-value">(045) 900-4473 Loc. 107</span>
                                </div>
                            </div>
                            ...
                            <div class="dept-dean-contact">
                                ...
                                <div>
                                    <span class="dept-contact-label">Accountancy Office</span>
                                    <span class="dept-contact-value">Limlingan Hall, Floor 2, Room 210</span>
                                </div>
                            </div>

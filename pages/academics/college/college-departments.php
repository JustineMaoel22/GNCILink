            ...
            <div class="cp-college-row">
                ...
                <div class="cp-college">
                    ...
                    <div class="cp-college-info">
                        ...
                        <a href="/pages/academics/college/departments/cased.php" class="cp-view-link">View Programs <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="cp-college">
                    ...
                    <div class="cp-college-info">
                        ...
                        <a href="/pages/academics/college/departments/cba.php" class="cp-view-link">View Programs <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="cp-college">
                    ...
                    <div class="cp-college-info">
                        ...
                        <a href="/pages/academics/college/departments/coe.php" class="cp-view-link">View Programs <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="cp-college">
                    ...
                    <div class="cp-college-info">
                        ...
                        <a href="/pages/academics/college/departments/coa.php" class="cp-view-link">View Programs <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="cp-college">
                    ...
                    <div class="cp-college-info">
                        ...
                        <a href="/pages/academics/college/departments/conursing.php" class="cp-view-link">View Programs <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>

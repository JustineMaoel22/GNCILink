        ...
        <div class="dept-hero">
            <div class="dept-hero-inner">
                <nav class="dept-breadcrumb" aria-label="breadcrumb">
                    ...
                    <span class="dept-current">Graduate School</span>
                </nav>
        ...
        <div class="dept-about-inner skeleton-group">
            ...
            <div class="dept-logo-wrap">
                ...
                <div class="skeleton-wrap" style="display:inline-block;">
                    <img src="/assets/images/logos/gnc-logo-v1.svg" alt="College of Arts, Sciences, and Education seal" class="dept-logo">
                </div>
            ...
            <div class="dept-about-content">
                ...
                <div class="skeleton-real-content">
                    ...
                    <p>The Graduate School is committed to providing quality postgraduate education that develops highly competent professionals, responsible leaders, and innovative researchers.
                    Through advanced learning, research, and professional development, the department prepares graduates to address emerging challenges in education, business, public administration,
                    and other fields while contributing to the sustainable development of the nation and the preservation of Philippine culture and heritage.</p>
            ...
            <div class="dept-programs-grid">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/test-image.png" alt="Bachelor of Elementary Education">
                    </div>
                    <div class="dept-program-body">
                        ...
                        <div class="skeleton-real-content">
                            <h3>Doctor of Philosophy (Educational Management)</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/graduate-school/programs/phd-educ-mgt.php" class="dept-program-link">
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/test-image.png" alt="Bachelor of Secondary Education">
                    </div>
                    <div class="dept-program-body">
                        <div class="skeleton-text-lines">
                            <span class="skeleton-line skeleton-line--title skeleton-line--80"></span>
                        ...
                        <div class="skeleton-real-content">
                            <h3>Master of Arts in Education (Educational Management)</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/graduate-school/programs/ma-educ.php" class="dept-program-link">
                                VIEW DETAILS <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="dept-program-card skeleton-group">
                    <div class="dept-program-img skeleton-wrap">
                        <img src="/assets/images/test-image.png" alt="Bachelor of Arts in English Language">
                    </div>
                    <div class="dept-program-body">
                        <div class="skeleton-text-lines">
                            <span class="skeleton-line skeleton-line--title skeleton-line--80"></span>
                        ...
                        <div class="skeleton-real-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/graduate-school/programs/ma-business-admin.php" class="dept-program-link">
                                VIEW DETAILS <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="dept-program-card skeleton-group">
                    ...
                    <div class="dept-program-body">
                        ...
                        <div class="skeleton-real-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            <a href="/pages/academics/graduate-school/programs/ma-public-admin.php" class="dept-program-link">
                                VIEW DETAILS <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
    ...
    <section class="dept-dean">
        <div class="dept-dean-inner">
            ...
            <div class="dept-dean-intro">
                ...
                <p>Meet the visionary leader guiding the Graduate School in advancing academic excellence, innovation, and service.</p>
            </div>
            ...
            <div class="dept-dean-grid skeleton-group">
                ...
                <div class="dept-dean-photo-wrap">
                    ...
                    <div class="dept-dean-photo skeleton-wrap">
                        <img src="/assets/images/maam-nazal.png" alt="Dean of the Graduate School">
                        
                        <!-- Wave Pattern: Gold -> Maroon -> Light Green -->
                        ...
                        <div class="dept-dean-badge">
                            ...
                            <span class="dept-dean-badge-sub">Graduate School</span>
                        </div>
                    </div>
                    ...
                    <div class="skeleton-real-content">
                        ...
                        <div class="dept-dean-contacts-grid">
                            ...
                            <div class="dept-dean-contact">
                                ...
                                <div>
                                    <span class="dept-contact-label">Graduate School Office</span>
                                    <span class="dept-contact-value">BETA Hall, Floor 2, Room 202</span>
                                </div>
                            </div>

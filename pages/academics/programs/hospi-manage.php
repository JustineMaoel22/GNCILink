        ...
        <div class="row align-items-center g-0">
            <div class="col-lg-6">
                ...
                <div class="hospitality-hero-content">
                    ...
                    <p class="hospitality-subtitle">Exceptional Service. Global Standards. Genuine Hospitality.</p>
        ...
        <div class="container">
            ...
            <div class="row g-4 mt-2">
                <div class="col-lg-6">
                    <div class="hospitality-career-card">
                        <div class="hospitality-career-img">
                            <img src="/assets/images/hotel-operations-manager.png" alt="Hotel Operations Manager" loading="lazy">
                        </div>
                        <div class="hospitality-career-content">
                            <h5 class="hospitality-career-title">Hotel Operations Manager</h5>
                            <p class="hospitality-career-desc">
                                Oversee day-to-day hotel operations, staff, and guest services to ensure a
                ...
                <div class="col-lg-6">
                    <div class="hospitality-career-card">
                        <div class="hospitality-career-img">
                            <img src="/assets/images/event-planner.png" alt="Event and Wedding Planner" loading="lazy">
                        </div>
                        <div class="hospitality-career-content">
                            <h5 class="hospitality-career-title">Event and Wedding Planner</h5>
                            <p class="hospitality-career-desc">
                                Plan and coordinate events, weddings, and conferences from concept through
                                flawless execution.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="hospitality-career-card">
                        <div class="hospitality-career-img">
                            <img src="/assets/images/executive-chef.png" alt="Executive Chef" loading="lazy">
                        </div>
                        <div class="hospitality-career-content">
                            <h5 class="hospitality-career-title">Executive Chef</h5>
                            <p class="hospitality-career-desc">
                                Lead kitchen operations, menu development, and food quality standards in
                ...
                <div class="col-lg-6">
                    <div class="hospitality-career-card">
                        <div class="hospitality-career-img">
                            <img src="/assets/images/travel-tourism-consultant.png" alt="Travel and Tourism Consultant" loading="lazy">
                        </div>
                        <div class="hospitality-career-content">
                            <h5 class="hospitality-career-title">Travel and Tourism Consultant</h5>
                            <p class="hospitality-career-desc">
                                Advise clients on travel arrangements, itineraries, and tourism packages tailored
                                to their needs.
                            </p>
                        </div>
                    </div>

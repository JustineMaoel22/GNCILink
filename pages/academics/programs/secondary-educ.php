        ...
        <div class="row align-items-center g-0">
            <div class="col-lg-6">
                <nav class="educ-breadcrumb" aria-label="breadcrumb">
                    ...
                    <i class="bi bi-chevron-right"></i>
                    <a href="/pages/academics/departments/cased.php">COLLEGE OF ARTS, SCIENCE AND EDUCATION</a>
                    <i class="bi bi-chevron-right"></i>
                ...
                <div class="educ-hero-content">
                    ...
                    <p class="educ-desc">
                        The Bachelor of Secondary Education program prepares competent and innovative educators committed to guiding young learners, advancing quality education, 
                        and making a meaningful impact through effective teaching, professional excellence, and lifelong learning.
                    </p>
                </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 mt-2">
                <div class="col-lg-6">
                    <div class="educ-career-card">
                        <div class="educ-career-img">
                            <img src="/assets/images/secondary-school-teacher.png" alt="Secondary School Teacher" loading="lazy">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="educ-career-card">
                        <div class="educ-career-img">
                            <img src="/assets/images/curriculum-instruction-specialist.png" alt="Curriculum & Instruction Specialist" loading="lazy">
                        </div>
                        <div class="educ-career-content">
                ...
                <div class="col-lg-6">
                    <div class="educ-career-card">
                        <div class="educ-career-img">
                            <img src="/assets/images/education-training-specialist.png" alt="Education & Training Specialist" loading="lazy">
                        </div>
                        <div class="educ-career-content">
